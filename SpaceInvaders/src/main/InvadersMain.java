...
public class InvadersMain {
    ...
    public InvadersMain() throws SlickException, FileNotFoundException, IOException {
        setUpDisplay();
        setUpOpenGL();
        Effects.setUp();
        setUpEntities();
    ...
    private void setUpEntities() throws SlickException, FileNotFoundException, IOException {
    ...
    private void logic(int delta) throws IOException {
